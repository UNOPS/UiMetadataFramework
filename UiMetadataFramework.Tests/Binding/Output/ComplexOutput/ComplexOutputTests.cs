...
public class ComplexOutputTests
{
	...
	public void EachPanelSubclassHasItsOwnMetadata()
	{
		...
		var configObject1 = response1.AssertHasField(nameof(Response1.Box)).Component.Configuration;
		var configObject2 = response2.AssertHasField(nameof(Response2.User)).Component.Configuration;
		...
		config1.AssertHasField(nameof(Response1.BoxInfo.Weight));
		config2.AssertHasField(nameof(Response2.UserInfo.Name));
	}
}