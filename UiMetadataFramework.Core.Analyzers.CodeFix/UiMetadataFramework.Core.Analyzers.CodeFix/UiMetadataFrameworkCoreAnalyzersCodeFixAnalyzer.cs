namespace UiMetadataFramework.Core.Analyzers.CodeFix
{
    ...
    public class UiMetadataFrameworkCoreAnalyzersCodeFixAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "UiMetadataFrameworkCoreAnalyzersCodeFix";
